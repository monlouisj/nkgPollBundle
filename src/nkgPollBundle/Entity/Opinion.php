...
namespace nkgPollBundle\Entity;
 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="nkgPollBundle\Entity\OpinionRepository")
 */
class Opinion
{
    /**
     ...
     * Set poll
     *
     * @param \nkgPollBundle\Entity\Poll $poll
     * @return Opinion
     */
    public function setPoll(\nkgPollBundle\Entity\Poll $poll = null)
    {
        $this->poll = $poll;
